                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 flex gap-2">
                                ...
                                <a href="{{ route('consultation.view', $visit->visit_token) }}" 
                                    class="inline-flex items-center px-3 py-1 text-sm rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 transition transform hover:scale-[1.05] border border-blue-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-8 text-center text-gray-500 bg-gray-50">
                             No patients currently waiting or in consultation matching your criteria.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
