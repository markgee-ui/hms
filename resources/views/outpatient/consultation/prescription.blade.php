            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-300">
                    <thead class="bg-gray-100 border-b border-gray-300">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase border-r border-gray-300">Patient</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase border-r border-gray-300">Visit Token</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase border-r border-gray-300">Prescription Details</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase border-r border-gray-300">Status</th>
                    ...
                    <tbody class="divide-y divide-gray-300">
                        @foreach($prescriptions as $prescription)
                            <tr class="hover:bg-indigo-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 border-r border-gray-300 max-w-xs truncate">
